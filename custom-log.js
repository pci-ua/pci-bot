...
Date.prototype.toLogString = function () { return `[ ${this.getFullYear()}/${(this.getMonth()+1).toString().padStart(2,0)}/${(this.getDay()).toString().padStart(2,0)} ${this.getHours().toString().padStart(2,0)}:${this.getMinutes().toString().padStart(2,0)} ${this.getSeconds()}' ]`; }
